...
export default function CustomizedDialogs(props) {
  ...
  const handleFileChange = (fileName, fileId) => {
    setEditCVD({ ...EditCVD, fileName: fileName, fileId: fileId });
  };
          ...
          <DialogContent>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <FormControl variant="outlined" fullWidth>
                  {`File : ${
                    EditCVD.fileName ? EditCVD.fileName : rowData[10]
                  }`}
                </FormControl>
              </Grid>
              ...
              >
                <BorderLinearProgress
                  variant={EditCVD.fileId ? 'determinate' : 'indeterminate'}
                  value={100}
                />
                <span
                  style={{
